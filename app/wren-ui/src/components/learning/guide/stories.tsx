  ...
  $driver.setSteps([
    {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            Create and manage <b>Question-SQL pairs</b> to refine Atlas SQL
            ...
            save, the smarter Atlas becomes!
          </>,
        ),
        onPopoverRender: (popoverDom: DriverPopoverDOM) => {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            ...
            guide Atlas in applying consistent filters, constraints, and best
