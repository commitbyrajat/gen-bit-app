CREATE SCHEMA IF NOT EXISTS iceberg.lending
WITH (location = 's3://wren-iceberg/lending/');

DROP TABLE IF EXISTS iceberg.lending.loan_provider_assignments;
DROP TABLE IF EXISTS iceberg.lending.repayments;
DROP TABLE IF EXISTS iceberg.lending.loans;
DROP TABLE IF EXISTS iceberg.lending.loan_products;
DROP TABLE IF EXISTS iceberg.lending.provider_branches;
DROP TABLE IF EXISTS iceberg.lending.loan_providers;
DROP TABLE IF EXISTS iceberg.lending.borrowers;
...
INSERT INTO iceberg.lending.borrowers VALUES
...
INSERT INTO iceberg.lending.loan_providers VALUES
...
INSERT INTO iceberg.lending.provider_branches VALUES
...
INSERT INTO iceberg.lending.loan_products VALUES
...
INSERT INTO iceberg.lending.loans VALUES
...
INSERT INTO iceberg.lending.loan_provider_assignments VALUES
...
INSERT INTO iceberg.lending.repayments VALUES
